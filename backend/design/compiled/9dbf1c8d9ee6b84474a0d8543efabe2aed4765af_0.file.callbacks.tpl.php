<?php /* Smarty version 3.1.27, created on 2016-08-13 07:06:53
         compiled from "backend\design\html\callbacks.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:614857ae9cdd27d8e9_38343765%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '614857ae9cdd27d8e9_38343765',
  'variables' => 
  array (
    'manager' => 0,
    'callbacks' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_57ae9cdd30e181_47378107',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57ae9cdd30e181_47378107')) {
function content_57ae9cdd30e181_47378107 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '614857ae9cdd27d8e9_38343765';
?>
...
"/>
            <div id="list" class="sortable">
                <?php
$_from = $_smarty_tpl->tpl_vars['callbacks']->value;
if (!is_array($_from) && !is_object($_from)) {
settype($_from, 'array');
}
$_smarty_tpl->tpl_vars['callback'] = new Smarty_Variable;
$_smarty_tpl->tpl_vars['callback']->_loop = false;
foreach ($_from as $_smarty_tpl->tpl_vars['callback']->value) {
$_smarty_tpl->tpl_vars['callback']->_loop = true;
$foreach_callback_Sav = $_smarty_tpl->tpl_vars['callback'];
?>
...
" target="_blank">Страница с которой было отправлено</a>
 ...
 в <?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['time'][0][0]->time_modifier($_smarty_tpl->tpl_vars['callback']->value->date);?>
                ...
                <?php
$_smarty_tpl->tpl_vars['callback'] = $foreach_callback_Sav;
}
?>
            </div>
