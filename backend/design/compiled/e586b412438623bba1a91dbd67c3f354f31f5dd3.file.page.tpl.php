<?php /* Smarty version Smarty-3.1.18, created on 2016-08-01 17:42:27
         compiled from "backend\design\html\page.tpl" */ ?>
<?php /*%%SmartyHeaderCode:10084579f5fd3e3bc10-47490121%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10084579f5fd3e3bc10-47490121',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_579f5fd402e1d7_79845544',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_579f5fd402e1d7_79845544')) {function content_579f5fd402e1d7_79845544($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_replace')) include 'O:\\domains\\okay\\Smarty\\libs\\plugins\\modifier.replace.php';
...
?>
            <li <?php if ($_smarty_tpl->tpl_vars['m']->value->id==$_smarty_tpl->tpl_vars['menu']->value->id) {?>class="active"<?php }?>>
                <a href='index.php?module=PagesAdmin&menu_id=<?php echo $_smarty_tpl->tpl_vars['m']->value->id;?>
		...
		<div class="block">
			<ul>
				<li>
                    ...
                    <input name="name" class="okay_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value->name, ENT_QUOTES, 'UTF-8', true);?>
" />
                </li>
				<li>
		...
		<div class="block layer">
			...
			<ul>
				...
				<li>
                    ...
                    <input name="url" class="page_url" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value->url, ENT_QUOTES, 'UTF-8', true);?>
" />
                </li>
				<li>
...
" />
				...
				<li>
                    ...
                    <textarea name="meta_description" class="okay_inp"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['page']->value->meta_description, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                </li>
			</ul>
		</div>
