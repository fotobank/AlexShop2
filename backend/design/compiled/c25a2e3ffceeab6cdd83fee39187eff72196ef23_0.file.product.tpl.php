<?php /* Smarty version 3.1.27, created on 2016-08-13 07:06:12
         compiled from "backend\design\html\product.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:595757ae9cb4e34609_72249780%%*/
...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '595757ae9cb4e34609_72249780',
  'variables' => 
  array (
    'product' => 0,
    'manager' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_57ae9cb518e229_50659154',
  'tpl_function' => 
  array (
    'category_select' => 
    array (
      ...
      'compiled_filepath' => 'backend/design/compiled\\c25a2e3ffceeab6cdd83fee39187eff72196ef23_0.file.product.tpl.php',
      'uid' => 'c25a2e3ffceeab6cdd83fee39187eff72196ef23',
      'call_name' => 'smarty_template_function_category_select_595757ae9cb4e34609_72249780',
    ),
  ),
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_57ae9cb518e229_50659154')) {
function content_57ae9cb518e229_50659154 ($_smarty_tpl) {
...
$_smarty_tpl->properties['nocache_hash'] = '595757ae9cb4e34609_72249780';
...
echo $_smarty_tpl->getSubTemplate ('include_languages.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0);
}?>
...
?>
                    <li>
                        ...
                        <span <?php if (!(isset($_smarty_tpl->tpl_vars['__foreach_categories']->value['first']) ? $_smarty_tpl->tpl_vars['__foreach_categories']->value['first'] : null)) {?>style='display:none;'<?php }?> class="f_right add">
                            <i class="dash_link">Дополнительная категория</i>
                        </span>
                        <span <?php if ((isset($_smarty_tpl->tpl_vars['__foreach_categories']->value['first']) ? $_smarty_tpl->tpl_vars['__foreach_categories']->value['first'] : null)) {?>style='display:none;'<?php }?> class="delete">
...
?>
    ...
    <div id="variants_block"
         <?php $_smarty_tpl->tpl_vars['first_variant'] = new Smarty_Variable($_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['first'][0][0]->first_modifier($_smarty_tpl->tpl_vars['product_variants']->value), null, 0);
...
$_smarty_tpl->tpl_vars['currency']->iteration=0;
foreach ($_from as $_smarty_tpl->tpl_vars['currency']->value) {
$_smarty_tpl->tpl_vars['currency']->_loop = true;
$_smarty_tpl->tpl_vars['currency']->iteration++;
$_smarty_tpl->tpl_vars['currency']->first = $_smarty_tpl->tpl_vars['currency']->iteration == 1;
...
"/></li>
                <li>
                    ...
                    <input name="meta_title" class="order_inp word_count" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->meta_title, ENT_QUOTES, 'UTF-8', true);?>
"/>
                </li>
                <li>
                    ...
                    <input name="meta_keywords" class="order_inp word_count" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->meta_keywords, ENT_QUOTES, 'UTF-8', true);?>
"/>
                </li>
                <li>
                    ...
                    <textarea name="meta_description" class="order_inp"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['product']->value->meta_description, ENT_QUOTES, 'UTF-8', true);?>
</textarea>
                </li>
            </ul>
        </div>
        <div class="block layer">
            ...
            <ul>
                <li>
                    ...
                    <input class="order_inp" type="text" name="rating" value="<?php echo $_smarty_tpl->tpl_vars['product']->value->rating;?>
"/>
                </li>
                <li>
                    <label class=property>Количество голосов: </label>
                    <input class="order_inp" type="text" name="votes" value="<?php echo $_smarty_tpl->tpl_vars['product']->value->votes;?>
"/>
                </li>
            </ul>
        </div>
...
">
                        ...
                        <input class="order_inp option_value" type="text" name="options[<?php echo $_smarty_tpl->tpl_vars['feature_id']->value;?>
...
"/>
                        <input class="order_inp grey_translit" style="margin-left:175px;margin-top:2px;" type="text" name="options[<?php echo $_smarty_tpl->tpl_vars['feature_id']->value;?>
...
$foreach_special_Sav = $_smarty_tpl->tpl_vars['special'];
?>
...
"/>
                <?php
$_smarty_tpl->tpl_vars['special'] = $foreach_special_Sav;
}
?>
            </div>
...
?><?php
/* smarty_template_function_category_select_595757ae9cb4e34609_72249780 */
if (!function_exists('smarty_template_function_category_select_595757ae9cb4e34609_72249780')) {
function smarty_template_function_category_select_595757ae9cb4e34609_72249780($_smarty_tpl,$params) {
