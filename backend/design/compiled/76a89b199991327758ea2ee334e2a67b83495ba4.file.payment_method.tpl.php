<?php /* Smarty version Smarty-3.1.18, created on 2016-08-01 17:28:11
         compiled from "backend\design\html\payment_method.tpl" */ ?>
<?php /*%%SmartyHeaderCode:17880579f5c7bdd26f5-22672565%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '17880579f5c7bdd26f5-22672565',
  'function' => 
  array (
  ),
  'variables' => 
  ...
  'unifunc' => 'content_579f5c7c074961_06223112',
),false); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_579f5c7c074961_06223112')) {function content_579f5c7c074961_06223112($_smarty_tpl) {?>
...
<?php if ($_smarty_tpl->tpl_vars['message_success']->value) {?>
    ...
    <div class="message message_success">
        <span class="text"><?php if ($_smarty_tpl->tpl_vars['message_success']->value=='added') {?>Способ оплаты добавлен<?php } elseif ($_smarty_tpl->tpl_vars['message_success']->value=='updated') {?>Способ оплаты изменен<?php } else { ?><?php echo $_smarty_tpl->tpl_vars['message_success']->value;?>
<?php }?></span>
        <?php if ($_GET['return']) {?>
...
"/> 
		<div class="checkbox">
			<input name=enabled value='1' type="checkbox" id="active_checkbox" <?php if ($_smarty_tpl->tpl_vars['payment_method']->value->enabled) {?>checked<?php }?>/>
...
?>
                    ...
                    <?php if (count($_smarty_tpl->tpl_vars['setting']->value->options)>1) {?>
                        <li>
                            <label class=property><?php echo $_smarty_tpl->tpl_vars['setting']->value->name;?>
</label>
...
' <?php if ($_smarty_tpl->tpl_vars['option']->value->value==$_smarty_tpl->tpl_vars['payment_settings']->value[$_smarty_tpl->tpl_vars['setting']->value->variable]) {?>selected<?php }?>><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value->name, ENT_QUOTES, 'UTF-8', true);?>
                        ...
                        <li>
                            <label class="property" for="<?php echo $_smarty_tpl->tpl_vars['setting']->value->variable;?>
...
]" class="okay_inp" type="checkbox" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['option']->value->value, ENT_QUOTES, 'UTF-8', true);?>
...
"><?php echo htmlspecialchars($_smarty_tpl->tpl_vars['setting']->value->name, ENT_QUOTES, 'UTF-8', true);?>
                            ...
                            <input name="payment_settings[<?php echo $_smarty_tpl->tpl_vars['setting']->value->variable;?>
]" class="okay_inp" type="text" value="<?php echo htmlspecialchars($_smarty_tpl->tpl_vars['payment_settings']->value[$_smarty_tpl->tpl_vars['setting']->value->variable], ENT_QUOTES, 'UTF-8', true);?>
            ...
            <?php if ($_smarty_tpl->tpl_vars['payment_method']->value->image) {?>
                <ul>
                    <li>
                        ...
                        <img src="<?php echo $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_MODIFIER]['resize'][0][0]->resize_modifier($_smarty_tpl->tpl_vars['payment_method']->value->image,100,100,false,$_smarty_tpl->tpl_vars['config']->value->resized_payments_dir);?>
" alt="" />
                    </li>
                </ul>
            <?php }?>
