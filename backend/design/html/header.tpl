...
<div class="page-header navbar navbar-fixed-top">
	<div class="page-header-inner container">
		{*<!-- BEGIN LOGO -->*}
		<div class="page-logo">
			<a href = 'index.php?module=LicenseAdmin'>
				{*переделать логотип и удалить стиль*}
				<img style="width: 125px;" src = "/backend/design/images/logo.png" alt = "AlexShop CMS" class="logo-default"/>
			</a>
