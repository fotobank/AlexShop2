    ...
    <script type = "text/javascript">
        ...
        $(document).ready(function () {
                ...
                jQuery(function ($) {
                    ...
                    var ColN, ColM;
//                    ColN = $.cookie("grid_names_translations");
//                    ColM = $.cookie("grid_models_translations");
                    ColN = getLocalStorage("grid_names_translations");
                    ColM = getLocalStorage("grid_models_translations");
                    var sPath = window.location.pathname;
                    var sPage = sPath.substring(sPath.lastIndexOf('/') + 1);

//                    if (typeof ColN == 'undefined' || typeof ColM == 'undefined') {
                    if (ColN == null || ColM == null) {
                        $.ajax({
...
//                                    $.cookie("grid_names_translations", JSON.stringify(ColN), { expires: 1 });
//                                    $.cookie("grid_models_translations", JSON.stringify(ColM), { expires: 1 });
                                    delLocalStorage("grid_names_translations");
                                    delLocalStorage("grid_models_translations");
                                    setLocalStorage("grid_names_translations", ColN);
                                    setLocalStorage("grid_models_translations", ColM);
