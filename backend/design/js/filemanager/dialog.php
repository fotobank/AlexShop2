...
<body>
	...
	<input type="hidden" id="current_url" value="<?php echo str_replace(array('&filter='.$filter,'&sort_by='.$sort_by,'&descending='.(int)$descending),array(''),$base_url.$_SERVER['REQUEST_URI']); ?>" />
