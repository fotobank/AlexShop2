<li class="comment {if $comment->admin}admin{/if}">
	...
	<div class="foot">
		<a data-form="#comment-answer-{$comment->id}"
           href="ajax/comment.form.php?parent={$comment->id}&type=product&object_id={$product->id}"
           class="dotted comment-answer">ответить</a>
