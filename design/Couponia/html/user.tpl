...
<form class="form" method="post">
	...
	<input  class="form-control" id="password" value="" name="password" type="password" style="display:none;margin-bottom:15px;"/>
	<input type="submit" class="button btn btn-primary" value="Сохранить">
</form>
