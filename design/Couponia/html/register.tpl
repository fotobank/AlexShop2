...
<form class="form register_form" method="post">
	<label>Имя</label>
	<input  class="form-control" type="text" name="name" data-format=".+" data-notice="Введите имя" value="{$name|escape}" maxlength="255" />
	...
	<input type="submit" class="button btn btn-primary" name="register" value="Зарегистрироваться">
